...
class Generator extends \yii\gii\Generator
{
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['enableI18N', 'enablePjax', 'enableSmartFK'], 'boolean'],
    ...
    public function getNameAttribute()
    {
		...
		public function generateGridViewForeignKey($attribute){
			...
			$detail = "";
			$detail .= "[\n";
			$detail .= $space."\t'class' => yii\\grid\\DataColumn::className(), //<-- Modify according to needs. This is the default.\n";
			//use terniary operator to avoid a crash if foreign key is not set
			$attr = "";
			if($tableName == "user"){
				$foreignNameColumn = $this->defaultUsernameColumn;
